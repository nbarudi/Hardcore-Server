...
/**
 * File Manager class I've used for years for multiple configs.
 * Thank you to <a href="https://www.spigotmc.org/threads/lib-file-manager-easy-config-manager.38152/">Bimmr</a> on Spigot-Forums!
 * */
public class FileManager {
    ...
    public class Config {
        ...
        public Config saveDefaultConfig() {
            ...
            //Added a check if the file already exists. Don't want to overwrite -Nick
            if(!file.exists()){
                Bukkit.getLogger().info("File " + this.name + " Exists");
